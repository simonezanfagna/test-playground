...
// il resize dopo aver fatto lo scroll.
  ...
  // effettuo la chiamata ajax al tab1.json in modo che al caricamento della pagina
  ...
  $('.p-tab-title').click(function () {
    ...
    // tolgo dal div con classe 'tab-content' il p con il contenuto del tab
    $('.tab-content p').remove();
    // effettuo la chiamata ajax al tab json per predere il contenuto del tab associato al titolo (p) cliccato
    $.ajax({
  ...
  $('form button').click(function () {
    ...
    var message = $('form[name=datiForm] textarea[name=message]').val();
